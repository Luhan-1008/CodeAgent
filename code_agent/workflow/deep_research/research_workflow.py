...
class ResearchWorkflow:
    ...
    def __init__(
            ...
            verbose: bool = False,
            **kwargs):
        from code_agent.workflow.deep_research.principle import MECEPrinciple
    ...
    def run(self,
        ...
        from code_agent.rag.schema import KeyInformation
        from code_agent.tools.search.search_base import SearchResult
