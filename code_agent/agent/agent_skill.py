...
import json
from code_agent.llm import Message
from code_agent.llm.openai_llm import OpenAI as OpenAILLM
from code_agent.skill.loader import load_skills
from code_agent.skill.prompts import (PROMPT_SKILL_PLAN, PROMPT_SKILL_TASKS,
                                      PROMPT_TASKS_IMPLEMENTATION,
                                      SCRIPTS_IMPLEMENTATION_FORMAT)
from code_agent.skill.retrieve import create_retriever
from code_agent.skill.schema import ExecutionResult, SkillContext, SkillSchema
from code_agent.skill.skill_utils import (copy_with_exec_if_script,
...
from code_agent.utils.utils import install_package, str_to_md5
...
class AgentSkill:
    ...
    def _init_sandbox(self):
        ...
        """
        from code_agent.sandbox import EnclaveSandbox
